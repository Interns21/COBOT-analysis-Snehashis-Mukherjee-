...
for i = 1:length(t)
    ...
    th3(i) = [1, t(i), t(i)^2, t(i)^3]*tc3;
    th4(i) = [1, t(i), t(i)^2, t(i)^3]*tc4;
    th5(i) = [1, t(i), t(i)^2, t(i)^3]*tc5;
    th6(i) = [1, t(i), t(i)^2, t(i)^3]*tc6;
...
figure(1)
grid on
plot3(xj(1:91),yj(1:91),zj(1:91), 'color', 'black', 'LineWidth', 3);
axis([-.15,.15,-.15,.15,-.15,.15]);
xlabel('xaxis');
ylabel('yaxis');
zlabel('zaxis');
